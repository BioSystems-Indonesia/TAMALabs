...
func InitRestApp() server.RestServer {
	...
	nuhaSIMRSUsecase := provideNuhaSIMRSUsecase(simrsNuha)
	configUsecase := provideConfigUsecaseForCron(configrepoRepository)
	cronHandler := cron.NewCronHandler(khanzaucUsecase, simrsucUsecase, simgosucUsecase, nuhaSIMRSUsecase, configUsecase)
