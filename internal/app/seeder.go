...
var seedDataTestType = []entity.TestType{
	// Hematology Tests
	{Name: "HEMOGLOBIN", Code: "HGB", Unit: "g/dL", LowRefRange: 12.0, HighRefRange: 17.0, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 1, Category: "Hematology", SubCategory: "Red Series", Description: "Hemoglobin concentration in blood.", IsCalculatedTest: false},
	{Name: "HEMATOCRIT", Code: "HCT", Unit: "%", LowRefRange: 33.0, HighRefRange: 45.0, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 1, Category: "Hematology", SubCategory: "Red Series", Description: "Percentage of red blood cells in blood.", IsCalculatedTest: false},
	{Name: "LEUKOSIT", Code: "WBC", Unit: "10^3/µL", LowRefRange: 4.00, HighRefRange: 10.00, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 2, Category: "Hematology", SubCategory: "White Series", Description: "White blood cell count.", IsCalculatedTest: false},
	{Name: "TROMBOSIT", Code: "PLT", Unit: "10^3/µL", LowRefRange: 130, HighRefRange: 400, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 0, Category: "Hematology", SubCategory: "Platelets", Description: "Platelet count in blood.", IsCalculatedTest: false},
	{Name: "ERITROSIT", Code: "RBC", Unit: "10^6/µL", LowRefRange: 4.50, HighRefRange: 5.50, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 2, Category: "Hematology", SubCategory: "Red Series", Description: "Red blood cell count.", IsCalculatedTest: false},
	{Name: "MCV", Code: "MCV", Unit: "µm3", LowRefRange: 75.0, HighRefRange: 100.0, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 1, Category: "Hematology", SubCategory: "Red Series", Description: "Mean corpuscular volume.", IsCalculatedTest: false},
	{Name: "MCH", Code: "MCH", Unit: "pg", LowRefRange: 25.0, HighRefRange: 35.0, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 1, Category: "Hematology", SubCategory: "Red Series", Description: "Mean corpuscular hemoglobin.", IsCalculatedTest: false},
	{Name: "MCHC", Code: "MCHC", Unit: "g/dL", LowRefRange: 31.0, HighRefRange: 38.0, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 1, Category: "Hematology", SubCategory: "Red Series", Description: "Mean corpuscular hemoglobin concentration.", IsCalculatedTest: false},
	{Name: "LYM%", Code: "LYM%", Unit: "%", LowRefRange: 15.00, HighRefRange: 50.00, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 2, Category: "Hematology", SubCategory: "White Series", Description: "Percentage of lymphocytes in white blood cells.", IsCalculatedTest: false},
	{Name: "GRA%", Code: "GRA%", Unit: "%", LowRefRange: 35.00, HighRefRange: 80.00, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 2, Category: "Hematology", SubCategory: "White Series", Description: "Percentage of granulocytes in white blood cells.", IsCalculatedTest: false},
	{Name: "MID%", Code: "MID%", Unit: "%", LowRefRange: 2.0, HighRefRange: 15.0, Type: []entity.TestTypeSpecimenType{{Type: "WBL"}}, Decimal: 1, Category: "Hematology", SubCategory: "White Series", Description: "Mid-size cells in blood.", IsCalculatedTest: false},
