...
INSERT INTO `new_test_templates` (`id`, `name`, `description`, `test_types`, `doctor_ids`, `analyzer_ids`, `created_by`, `last_updated_by`, `created_at`, `updated_at`) SELECT `id`, `name`, `description`, `test_types`, IFNULL(`doctor_ids`, '[]') AS `doctor_ids`, IFNULL(`analyzer_ids`, '[]') AS `analyzer_ids`, `created_by`, `last_updated_by`, `created_at`, `updated_at` FROM `test_templates`;
