...
CREATE TABLE `test_type_devices` (
...
CREATE INDEX `idx_test_type_devices_test_type_id` ON `test_type_devices` (`test_type_id`);

CREATE INDEX `idx_test_type_devices_device_id` ON `test_type_devices` (`device_id`);